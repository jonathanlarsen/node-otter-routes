...
module.exports = function Otter(app, dir, options, next) {
    ...
    walk(directory, function(err, files) {
        files.forEach(function(file) {
            ...
            if (module) {
                ...
                if (method) {
                    ...
                    allRoutes.push(obj);
                    app._otterRoutes.push({module: obj.module, path: diagnostics[obj.module][obj.name].path, method: diagnostics[obj.module][obj.name].method});
                    ...
                    if (o.permissionMiddleware && requiredFile.permission !== null) {
                        obj.permission = o.permissionMiddleware;
                    }

                    if (requiredFile.permission) {
                        obj.permission = requiredFile.permission;
                    }
        ...
        allRoutes.forEach(function(route) {
            ...
            if (route.permission) {
                routerCache[route.module].router[route.method](route.routeString.toLowerCase(), route.permission, route.controller);
            } else {
        ...
        if (o.diagnostics) {
            require('./diagnostics')(app, diagnostics, next);
        } else {
            if (next) next();
        }
    });
